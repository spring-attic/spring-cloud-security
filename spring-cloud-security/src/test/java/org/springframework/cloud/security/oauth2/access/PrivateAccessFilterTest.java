...
public class PrivateAccessFilterTest {
    ...
    @Autowired
    private SecureAccessLevelProperties secureAccessLevelProperties;
    ...
    @Test
    public void filterShouldNotTriggerNullServletPath() {
        MockHttpServletRequest request = createRequest(null, false);
        PrivateAccessFilter filter = createFullAccessFilter(request);
        assertFalse("shouldFilter returned true", filter.shouldFilter());
    }
    ...
    private PrivateAccessFilter createFullAccessFilter(HttpServletRequest request) {
        ...
        RequestContext.testSetCurrentContext(context);
        return new PrivateAccessFilter(secureAccessLevelProperties);
    }
    ...
    protected static class Config {
        ...
        @Bean
        public SecureAccessLevelProperties secureAccessLevelProperties() {
            return new SecureAccessLevelProperties();
        }
